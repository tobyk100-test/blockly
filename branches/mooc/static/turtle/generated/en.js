...
turtlepage.startBlocks = function(opt_data, opt_ignored, opt_ijData) {
  ...
  if (opt_ijData.page == 1) {
    ...
    if (opt_ijData.level == 3 || opt_ijData.level == 5) {
      ...
      output += '<block type="controls_repeat" editable="false" deleteable="false" movable="false"><title name="TIMES">???</title><statement name="DO"><block type="draw_colour"><value name="COLOUR"><block type="colour_random"></block></value><next><block type="draw_a_square" inline="true" editable="false" deleteable="false" movable="false"><value name="VALUE"><block type="math_number" editable="false" deleteable="false" movable="false"><title name="NUM">???</title></block></value><next><block type="draw_turn" editable="false" deleteable="false" movable="false"><value name="VALUE"><block type="math_number" editable="false" deleteable="false" movable="false"><title name="NUM">???</title></block></value></block></next></block></next></block></statement></block>';
    ...
    case 2:
      switch (opt_ijData.level) {
        ...
        case 8:
          ...
          break;
        case 9:
          output += 'Use a "count with" loop to draw a family of snowmen with heights of 110, 100, 90, 80, and 70, each 60 dots apart.';
          break;
        case 10:
...
turtlepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  if (opt_ijData.reinf) {
    ...
    output += '<script type="text/javascript" src="../slider.js"><\/script><script type="text/javascript" src="answers.js"><\/script><table class="nav-menu" width="100%" style="padding-top: 1em;"><tr><td><h1><span id="title"><a href="https://sites.google.com/site/computersciencefirst/">CS First</a> : ';
    switch (opt_ijData.page) {
      case 1:
        output += 'Turtle 1';
        break;
