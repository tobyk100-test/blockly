...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  switch (opt_ijData.level) {
    ...
    case 8:
      ...
      break;
    case 9:
      output += '<li id="turnLeftError1" class="feedback" style="display: none">Use the \'turn left\' block when I need to turn to the left.</li><li id="turnLeftError2" class="feedback" style="display: none">Drag and snap the \'turn left\' block inside the \'if-else\' block.</li><li id="elseError1" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="elseError2" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="isPathForwardError1" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="isPathForwardError2" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="whileError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="whileError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around all of your blocks.</li>';
      break;
    case 10:
      output += '<li id="isPathForwardError1" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="isPathForwardError2" class="feedback" style="display: none">Use an \'if-else\' block to go straight if there is a path ahead and turn if there is no path ahead.</li><li id="elseError1" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="elseError2" class="feedback" style="display: none">An \'if-else\' block will run the else statement when the if statement is not true."</li><li id="whileError1" class="feedback" style="display: none">Notice the repetition in the path? Try using the \'repeat\' block which repeats the sequence of blocks inside it until, the player reaches the finish.</li><li id="whileError2" class="feedback" style="display: none">Drag and snap the \'repeat\' block around all of your blocks.</li>';
      break;
  }
