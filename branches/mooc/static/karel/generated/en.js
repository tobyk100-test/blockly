...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  var iLimit271 = opt_ijData.maxLevel + 1;
  for (var i271 = 1; i271 < iLimit271; i271++) {
    output += ' ' + ((i271 == opt_ijData.level) ? (i271 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i271) + '</span>' : '<span class="selected singleDigit tab">' + soy.$$escapeHtml(i271) + '</span>' : (i271 < opt_ijData.level) ? '<a class="tab previous" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i271) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i271) + '</a>' : '<a class="tab" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i271) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i271) + '</a>');
  }
