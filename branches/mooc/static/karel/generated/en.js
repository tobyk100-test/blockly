...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  var iLimit259 = opt_ijData.maxLevel + 1;
  for (var i259 = 1; i259 < iLimit259; i259++) {
    output += ' ' + ((i259 == opt_ijData.level) ? (i259 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i259) + '</span>' : '<span class="selected singleDigit tab">' + soy.$$escapeHtml(i259) + '</span>' : (i259 < opt_ijData.level) ? '<a class="tab previous" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i259) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i259) + '</a>' : '<a class="tab" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i259) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i259) + '</a>');
  }
