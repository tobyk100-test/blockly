...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  for (var i171 = 1; i171 < 17; i171++) {
    output += ' ' + ((i171 == opt_ijData.level) ? (i171 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i171) + '</span>' : '<span class="selected singleDigit tab">' + soy.$$escapeHtml(i171) + '</span>' : (i171 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i171) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i171) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i171) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i171) + '</a>');
  }
