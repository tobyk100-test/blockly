...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  var iLimit258 = opt_ijData.maxLevel + 1;
  for (var i258 = 1; i258 < iLimit258; i258++) {
    output += ' ' + ((i258 == opt_ijData.level) ? (i258 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i258) + '</span>' : '<span class="selected singleDigit tab">' + soy.$$escapeHtml(i258) + '</span>' : (i258 < opt_ijData.level) ? '<a class="tab previous" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i258) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i258) + '</a>' : '<a class="tab" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i258) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i258) + '</a>');
  }
