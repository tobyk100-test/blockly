...
mazepage.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none;">' + ((opt_ijData.page == 1) ? mazepage.toolboxPage1(opt_data, null, opt_ijData) : mazepage.toolboxPage2(opt_data, null, opt_ijData)) + '</xml>';
};


mazepage.toolboxPage1 = function(opt_data, opt_ignored, opt_ijData) {
...
mazepage.toolboxPage2 = function(opt_data, opt_ignored, opt_ijData) {
  return '';
};
